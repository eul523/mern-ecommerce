        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-100 via-white to-gray-50 flex">
                ...
                <div className="relative z-10 p-12 max-w-md">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 bg-white/10 p-4 rounded-2xl backdrop-blur-sm shadow-lg">
                            ...
                            <div>
                                <div className="text-sm font-semibold">New Arrival</div>
                                <div className="text-xs text-white/80">Limited edition sneakers — drop 10/25</div>
                            </div>
                            <div className="ml-auto text-sm font-semibold bg-white/20 px-3 py-1 rounded-full">20% off</div>
                        </div>

                        <div className="grid grid-cols-2 gap-3">
                            <div className="p-3 bg-white/8 rounded-2xl backdrop-blur-sm">
                                <div className="text-xs uppercase font-semibold tracking-wide">Free delivery</div>
                                <div className="text-sm font-medium mt-1">Orders over $50</div>
                            </div>
                            <div className="p-3 bg-white/8 rounded-2xl backdrop-blur-sm">
                                <div className="text-xs uppercase font-semibold tracking-wide">Secure</div>
                                <div className="text-sm font-medium mt-1">24/7 fraud protection</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <main className="flex-1 flex items-center justify-center p-8">
                <div className="w-full max-w-xl">
                        ...
                        <div className="md:flex">
                            ...
                            <div className="hidden md:block md:w-1/3 bg-gradient-to-b from-rose-50 via-white to-white p-8">
                                <div className="h-full flex flex-col justify-center gap-6">
                                    <div>
                                        <h3 className="text-lg font-bold text-rose-600">Welcome</h3>
                                        <p className="text-sm text-gray-600 mt-1">Sign in or create an account to continue shopping.</p>
                                    </div>
                                    <div className="space-y-2">
                                        <div className="text-xs uppercase text-gray-400 font-semibold">Why create an account?</div>
                                    ...
                                    <div className="text-xs text-gray-400">By continuing, you agree to our <a className="underline">Terms</a> & <a className="underline">Privacy</a>.</div>
                                </div>
                            </div>
                            ...
                            <div className="w-full md:w-2/3 p-8">
                                <div className="mb-6">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-sm text-gray-500">New here? <Link to='/register' className="font-medium text-rose-600">Create account</Link></div>
                                    </div>
                                    <p className="mt-2 text-sm text-gray-500">Use your email to sign in or continue with Google below.</p>
                                </div>

                                <form className="space-y-4" onSubmit={handleSubmit(onSubmit)} aria-label="login form">
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1 relative">
                                            <input {...register('password', { required: 'Password is required', minLength: { value: 6, message: 'Password must be atleast 6 characters.' } })} type={showPassword ? "text" : "password"} required autoComplete="current-password" className="w-full rounded-xl border border-gray-200 px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-rose-300" placeholder="Enter your password" />
                                            {errors.password && <p className="text-red-500 text-[0.7rem] sm:text-sm">{errors.password.message}</p>}
                                            <button onClick={()=>setShowPassword(!showPassword)} type="button" aria-hidden="true" className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-gray-400">{showPassword ? 'Hide' : 'Show'}</button>
                                        </div>
                                    </div>
                    ...
                    {/* Subtle footer */}
                    <div className="mt-6 text-center text-xs text-gray-400">© {new Date().getFullYear()} Shopify — crafted for modern commerce</div>
                </div>
            </main>
        </div>
    );
